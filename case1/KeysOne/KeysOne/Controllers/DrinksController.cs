...
namespace KeysOne.Controllers
{
    ...
    public class DrinksController : ControllerBase
    {
        ...
        public DrinksController(MachineDrinksContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Drink>> PostDrink(Drink drink)
        {
            ...
            return CreatedAtAction("GetDrink", new { id = drink.IdDrink }, drink);
        }
        ...
        {
            return _context.Drinks.Any(e => e.IdDrink == id);
        }
    }
}
