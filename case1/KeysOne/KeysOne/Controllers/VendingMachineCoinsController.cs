...
namespace KeysOne.Controllers
{
    ...
    public class VendingMachineCoinsController : ControllerBase
    {
        ...
        public VendingMachineCoinsController(MachineDrinksContext context)
        {
            _context = context;
        }
        ...
        {
            var vendingMachineCoins = await _context.VendingMachineCoins
                .Include(machineCoin => machineCoin.IdCoinNavigation)
                .Include(machineCoin => machineCoin.IdVendingMachineNavigation)
                .ToListAsync();
        ...
        {
            if (id != vendingMachineCoin.IdVendingMachineCoins)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<VendingMachineCoin>> PostVendingMachineCoin(VendingMachineCoin vendingMachineCoin)
        {
            ...
            return CreatedAtAction("GetVendingMachineCoin", new { id = vendingMachineCoin.IdVendingMachineCoins }, vendingMachineCoin);
        }
        ...
        {
            return _context.VendingMachineCoins.Any(e => e.IdVendingMachineCoins == id);
        }
    }
}
