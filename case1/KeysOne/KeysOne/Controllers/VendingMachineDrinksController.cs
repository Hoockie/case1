...
namespace KeysOne.Controllers
{
    ...
    public class VendingMachineDrinksController : ControllerBase
    {
        ...
        public VendingMachineDrinksController(MachineDrinksContext context)
        {
            _context = context;
        }
        ...
        {
            var vendingMachineDrinks = await _context.VendingMachineDrinks
            .Include(machineDrink => machineDrink.Drinks)
            .Include(machineDrink => machineDrink.IdVendingMachineNavigation)
            .ToListAsync();
        ...
        {
            if (id != vendingMachineDrink.IdVendingMachineDrinks)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<VendingMachineDrink>> PostVendingMachineDrink(VendingMachineDrink vendingMachineDrink)
        {
            ...
            return CreatedAtAction("GetVendingMachineDrink", new { id = vendingMachineDrink.IdVendingMachineDrinks }, vendingMachineDrink);
        }
        ...
        {
            return _context.VendingMachineDrinks.Any(e => e.IdVendingMachineDrinks == id);
        }
    }
}
